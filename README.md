# [SOLVED] Error-Listen-Eaddrinuse-While-Using-Nodejs
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/error-listen-eaddrinuse-while-using-nodejs)
>
...
Try listening on a different port or use a reverse proxy server to forward requests from port 80 to your NodeJS server.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/error-listen-eaddrinuse-while-using-nodejs)**
